...
\begin{document}
	...
	\begin{figure}[H]
		...
		\caption{The home landing page for the web app.}
		\label{fig:form}
	\end{figure}
	...
	\begin{figure}[H]
		...
		\caption{The web display of the prediction results.}
		\label{fig:results}
	\end{figure}
